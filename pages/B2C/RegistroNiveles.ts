...
export class RegistroNiveles {
	...
	async terminarNivelDosConExperencia(): Promise<void> {
		...
		await this.page.getByRole('textbox', { name: 'Funciones del cargo' }).click();
	...
	async terminarNivelDosConExperenciaYNoVigente(): Promise<void> {
		...
		await this.page.getByRole('textbox', { name: 'Nombre específico del cargo' }).click();
		await this.page.getByRole('textbox', { name: 'Nombre específico del cargo' }).fill('qa');
		await this.page.getByRole('textbox', { name: 'Empresa' }).click();
		await this.page.getByRole('textbox', { name: 'Empresa' }).fill('qa');
		await this.page.getByRole('textbox', { name: 'Funciones del cargo' }).click();
		await this.page.getByRole('textbox', { name: 'Funciones del cargo' }).fill('qaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa');
	...
	async terminarNivelDosConEstudios(): Promise<void> {
		...
		await this.page.getByRole('textbox', { name: '¿Qué estudiaste?' }).click();
		await this.page.getByRole('textbox', { name: '¿Qué estudiaste?' }).press('CapsLock');
		await this.page.getByRole('textbox', { name: '¿Qué estudiaste?' }).fill('I');
		await this.page.getByRole('textbox', { name: '¿Qué estudiaste?' }).press('CapsLock');
		await this.page.getByRole('textbox', { name: '¿Qué estudiaste?' }).fill('Ing informatica');
		...
		await this.page.getByRole('textbox', { name: '¿Título obtenido (profesión)?' }).click();
		await this.page.getByRole('textbox', { name: '¿Título obtenido (profesión)?' }).fill('Ing informatico');
		await this.page.locator('label').filter({ hasText: /^No$/ }).locator('div').click();
	...
	async terminarNivelTres(): Promise<void> {
		...
		await this.page.getByRole('button', { name: 'Medellín, Antioquia, Colombia' }).click();
		await this.page.getByText('Dirección').click();
		await this.page.getByRole('textbox', { name: 'Dirección' }).fill('calle10');
